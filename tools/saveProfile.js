...
export const saveProfile = tool(
  ...
  },
  {
    ...
    description: "Guarda información del perfil del usuario durante la conversación para ofrecerle promociones de Cinépolis. Incluye datos sobre términos aceptados, número de personas, cine de destino, tipo de promoción deseada.",
